...
@section('content')
    <div class="container mt-3">
        <h2 class="fw-bold text-info">Ubah Destinasi</h2>
        ...
        <div class="row">
            <div class="col-md-7">
                <form action="{{ route('update_travel_list', $destination->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" name="price"
                                        ...
                                        value="{{ old('price') == null ? $destination->curr_price : old('price') }}"
                            ...
                            <div class="col">
                                ...
                                <input type="number" name="discount"
                                    ...
                                    value="{{ old('discount') == null ? $destination->discount : old('discount') }}"
                                    placeholder="Diskon">
                                @error('discount')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
